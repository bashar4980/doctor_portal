      ...
      <form onSubmit={handleSubmit(signupHandeler)} className="space-y-6">
        ...
        <div className="space-y-1 text-sm">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-md border-gray-700 border text-neutral focus:border-violet-400" required
          />
        ...
        <div className="space-y-1 text-sm">
          ...
          {errors.password?.type === "pattern" && (
            <span className="text-red-400">Password must be Minimum eight characters, at least one letter, one number and one special character:</span>
          )}
        </div>
        <button
          type="submit"
